...
export default function Booking() {
  ...
  return <section className="booking section" id="booking"><div className="container booking-grid">
    <div className="booking-copy"><p className="eyebrow">PLAN YOUR ESCAPE</p><h2>Stay with us.<br /><em>Make memories.</em></h2><p>Tell us your preferred dates and we'll get back to you with availability and the best available rate.</p><div className="contact-mini"><span>Reservations</span><a href="tel:+919876543210">+91 98765 43210</a><a href="mailto:reservations@aureliaresort.com">reservations@aureliaresort.com</a></div></div>
    <form className="booking-form" onSubmit={handleSubmit}>
      <div className="form-row"><label>Full Name<input type="text" name="name" placeholder="Your name" required /></label><label>Phone<input type="tel" name="phone" placeholder="+91 XXXXX XXXXX" required /></label></div>
